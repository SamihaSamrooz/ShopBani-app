...
import 'package:shop_bani/admin/home_admin.dart';
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          child: Stack(
            children: [
              //container showing the design of the screen
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color.fromARGB(255, 161, 92, 92), Colors.black],
                ...
                child: Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      //the Material widget on top of the container
                      Material(
                        elevation: 3.0,
